...
@Component({
  selector: 'app-dash-top20marker',
  templateUrl: './dash-top20marker.component.html',
  styleUrls: ['./dash-top20marker.component.css']
})
export class DashTop20markerComponent implements OnInit {
  ...
  LoadGridData() {
    ...
    this.spinner.show()
    this.DashboardServ.DashTop20MarkerFill(SaveObj).subscribe((FillRes) => {
  ...
  FillViewPara() {
    this.ViewParaMastServ.ViewParaFill({ FORMNAME: 'DashTop20' }).subscribe((VPRes) => {
      try {
        if (VPRes.success == 1) {
